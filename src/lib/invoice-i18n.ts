...
const ES: Strings = {
  ...
  workContext: "Proyecto / referencia",
  phone: "Teléfono",
  email: "Correo",
  address: "Dirección",
  ...
  mail: {
    ...
    body: "Adjuntamos la factura por los servicios realizados. Si tienes alguna pregunta, contáctanos directamente.",
    ...
    poweredBy: "Enviado con GABAN Agency Management",
  },
};
...
const EN: Strings = {
  ...
  mail: {
    ...
    body: "Please find attached the invoice for services performed. If you have any questions, contact us directly.",
    ...
    poweredBy: "Sent with GABAN Agency Management",
  },
};
...
const FR: Strings = {
  ...
  mail: {
    ...
    body: "Veuillez trouver ci-joint la facture pour les services effectués. Pour toute question, contactez-nous directement.",
    ...
    poweredBy: "Envoyé avec GABAN Agency Management",
  },
};
