...
import { z } from "zod";
import { LINE_ITEM_TYPES_FOR_VALIDATION } from "@/lib/line-item-types";
...
export const lineItemSchema = z.object({
  ...
  itemType: z.enum(LINE_ITEM_TYPES_FOR_VALIDATION),
...
export const invoiceSchema = z.object({
  billingProfileId: z.string().min(1, "Selecciona un perfil de facturación"),
