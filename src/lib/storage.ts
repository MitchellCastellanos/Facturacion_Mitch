...
/** Sube o reemplaza el logo de un perfil de facturación. */
export async function uploadBillingProfileLogoToStorage(
  shopId: string,
  profileId: string,
  buffer: Buffer,
  mimeType: string,
  ...
  const storagePath = `logos/${shopId}/billing-profiles/${profileId}.${ext}`;
