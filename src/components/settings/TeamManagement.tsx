...
import { roleLabel, type ShopRole } from "@/lib/roles";

type Role = ShopRole | "MECHANIC";
...
export function TeamManagement({ members, currentUserId }: TeamManagementProps) {
  ...
  function handleRoleChange(userId: string, role: ShopRole) {
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Crea cuentas para tu equipo. Los miembros pueden facturar y cotizar; los de solo lectura
            ven sin modificar.
          </p>
        </div>
        <button
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                {member.id === currentUserId ? (
                  ...
                  <select
                    value={member.role === "MECHANIC" ? "MEMBER" : member.role}
                    disabled={pending}
